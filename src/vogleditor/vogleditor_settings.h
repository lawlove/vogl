...
public:
    ...
    bool groups_state_render() { return m_settings.groups_state_render; }
    bool groups_push_pop_markers() { return m_settings.groups_push_pop_markers; }
    bool groups_nested_calls() { return m_settings.groups_nested_calls; }
    void set_groups_state_render(bool groups_state_render) { m_settings.groups_state_render = groups_state_render; }
    void set_groups_push_pop_markers(bool groups_push_pop_markers) { m_settings.groups_push_pop_markers = groups_push_pop_markers; }
    void set_groups_nested_calls(bool groups_nested_calls) { m_settings.groups_nested_calls = groups_nested_calls; }
